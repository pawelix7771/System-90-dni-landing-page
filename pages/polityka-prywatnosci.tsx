    ...
    <main className={styles.page}>
      <div className={styles.inner}>
        ...
        <ul>
          ...
          <li>
            adres:{" "}
            <span className={styles.placeholder}>[adres]</span>
          </li>
          <li>
        ...
        <p>
          ...
          <span className={styles.placeholder}>[np. 24 miesiące]</span>{" "}
          od ich zebrania.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <span className={styles.placeholder}>
              [uzupełnij, jeśli używasz np. Google Analytics/Plausible:
              nazwa narzędzia i cel]
            </span>
            ; ładowane wyłącznie po wyrażeniu zgody.
          </li>
        </ul>
